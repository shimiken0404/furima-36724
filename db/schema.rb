...
ActiveRecord::Schema.define(version: 2021_10_07_112301) do
  ...
  create_table "get_users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["buy_item_id"], name: "index_get_users_on_buy_item_id"
  end
  ...
  add_foreign_key "get_users", "buy_items"
